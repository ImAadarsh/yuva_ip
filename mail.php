...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['full_name']) && isset($_POST['email']) && isset($_POST['phone'])) {
    ...
    $school = filter_var($_POST['school_name'], FILTER_SANITIZE_STRING);
    $grade = filter_var($_POST['grade'], FILTER_SANITIZE_STRING);
    $topic = filter_var($_POST['theme'], FILTER_SANITIZE_STRING);
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px;">
        ...
        <div style="text-align: center; padding-bottom: 20px;">
            <img src="http://yuva.ipnfoundation.org/assets/images/Logo.png" alt="YUVA Student Dialogue Logo" style="max-width: 200px;">
        </div>
        ...
        <div style="padding: 20px; color: #333333;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                ...
                <tr><td>Phone:</td><td><strong>' . htmlspecialchars($mobile) . '</strong></td></tr>
                <tr><td>Email:</td><td><strong>' . htmlspecialchars($email) . '</strong></td></tr>
                <tr><td>Preferred Theme:</td><td><strong>' . htmlspecialchars($topic) . '</strong></td></tr>
            </table>
...
';
                ...
                $mail->AltBody = 'Thank you for registering for the YUVA Student Dialogue 2025! We\'re excited to have you join us. Your registration details: Name: ' . $full_name . ', School: ' . $school . ', Grade: ' . $grade . ', Phone: ' . $mobile . ', Email: ' . $email . ', Preferred Theme: ' . $topic;

                $mail->send();
                echo json_encode(['message' => 'Your application has been submitted successfully! Please check your inbox or spam folder for confirmation.', 'success' => true]);
            } catch (Exception $e) {
                // Log the error but still show success to user
                error_log('PHPMailer Error: ' . $e->getMessage());
                echo json_encode(['message' => 'Your application has been submitted successfully! Email delivery may be delayed.', 'success' => true]);
            }
        } else {
    ...
    echo json_encode(['message' => 'Please fill all the required fields to complete your application.', 'success' => false]);
}
